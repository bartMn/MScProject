...
def get_flow_and_save(source, dest, env_num, cam_num):
    frame1_source = source +os.sep+ f"env{env_num}_cam{cam_num}_frame0.png"
    ...
    for i in tqdm(range(1, 121)):
        frame2_source = source +os.sep+ f"env{env_num}_cam{cam_num}_frame{i}.png"
        ...
        cv.imwrite(f'{dest+os.sep}env{env_num}_cam{cam_num}_frame{i}.png', bgr)
        prvs = next
...
def main():
    ...
    source = "/home/bart/project/IsaacGym_Preview_4_Package/isaacgym/IsaacGymEnvs-main/isaacgymenvs/recorded_data/cam_data_rgb"
    dest = "/home/bart/project/IsaacGym_Preview_4_Package/isaacgym/IsaacGymEnvs-main/isaacgymenvs/recorded_data/cam_data_flow"
